...
***NOTE: This tool IS NO LONGER PROFITABLE*** (and hasn't been for many months). 

I made several million gold with this at launch, but it is no longer viable and will never make profit again. Concepts used here may prove to be useful during future expansion launches, but at this point, this is nothing more than a historical archive for the project.
